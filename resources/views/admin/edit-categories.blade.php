                ...
                <form class="form-new-product form-style-1"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Category name" name="name" tabindex="0"
                            value="{{ $categories->name }}" aria-required="true" required="">
                    </fieldset>
                    @error('name')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Category Slug" name="slug" tabindex="0"
                            value="{{ $categories->slug }}" aria-required="true" required="">
                    </fieldset>
                    @error('slug')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                        ...
                        <div class="upload-image flex-grow">
                            @if ($categories->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset('storage/' . $categories->image) }}" class="effect8" alt="">
                                </div>
                            @endif
