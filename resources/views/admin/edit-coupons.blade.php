                ...
                <form class="form-new-product form-style-1" method="POST"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Coupon Code" name="code" tabindex="0"
                            value="{{ $coupons->code }}" aria-required="true" required="">
                    </fieldset>
                    @error('code')
                    ...
                    <fieldset class="category">
                        ...
                        <div class="select flex-grow">
                            <select class="" name="type">
                                ...
                                <option value="fixed" @selected($coupons->type == 'fixed')>Fixed</option>
                                <option value="percent" @selected($coupons->type == 'percent')>Percent</option>
                            </select>
                        </div>
                    </fieldset>
                    @error('type')
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Coupon Value" name="value" tabindex="0"
                            value="{{ $coupons->value }}" aria-required="true" required="">
                    </fieldset>
                    @error('value')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="text" placeholder="Cart Value" name="cart_value" tabindex="0"
                            value="{{ $coupons->cart_value }}" aria-required="true" required="">
                    </fieldset>
                    @error('cart_value')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
                    <fieldset class="name">
                        ...
                        <input class="flex-grow" type="date" placeholder="Expiry Date" name="expiry_date" tabindex="0"
                            value="{{ $coupons->expiry_date }}" aria-required="true" required="">
                    </fieldset>
                    @error('expiry_date')
                        <span class="alert alert-danger text-center">{{ $message }}</span>
                    @enderror
