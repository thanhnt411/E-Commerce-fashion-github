                            ...
                            <div class="select">
                                <select class="" name="category_id">
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" @selected($products->category_id == $category->id)>
                            ...
                            <div class="select">
                                <select class="" name="brand_id">
                                    ...
                                    @foreach ($brands as $brand)
                                        <option value="{{ $brand->id }}"@selected($products->brand_id == $brand->id)>{{ $brand->name }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="upload-image flex-grow">
                            @if ($products->image)
                                <div class="item" id="imgpreview">
                                    <img src="{{ asset('storage/' . $products->image) }}" class="effect8" alt="">
                                </div>
                            @endif
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="stock_status">
                                    <option value="instock" @selected($products->stock_status == 'instock')>InStock</option>
                                    <option value="outofstock" @selected($products->stock_status == 'outofstock')>Out of Stock</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('stock_status')
                        ...
                        <fieldset class="name">
                            ...
                            <div class="select mb-10">
                                <select class="" name="featured">
                                    <option value="0" @selected($products->featured == '0')>No</option>
                                    <option value="1" @selected($products->featured == '1')>Yes</option>
                                </select>
                            </div>
                        </fieldset>
                        @error('featured')
