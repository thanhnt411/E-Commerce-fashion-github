                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset('storage/' . $product->image) }}"
                                    ...
                                    @foreach (explode(',', $product->images) as $img)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto" src="{{ asset('storage/' . trim($img)) }}"
                                                width="674" height="674" alt="" />
                                            <a data-fancybox="gallery" href="{{ asset('storage/' . trim($img)) }}"
                                                data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <use href="#icon_zoom" />
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ asset('storage/' . $product->image) }}" width="104" height="104"
                                            alt="{{ $product->name }}" /></div>

                                    @foreach (explode(',', $product->images) as $img)
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto" src="{{ asset('storage/' . trim($img)) }}" width="104"
                                ...
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['product_slug' => $rproduct->slug]) }}">
                                        ...
                                        @foreach (explode(',', $rproduct->images) as $img)
                                            <img loading="lazy" src="{{ asset('storage/' . $img) }}" width="330"
                                    ...
                                    @else
                                        <form name="addtocart-form" method="post" action="{{ route('cart.add') }}">
                                            ...
                                            <input type="hidden" name="price"
                                                value="{{ $product->sale_price == '' ? $rproduct->regular_price : $rproduct->sale_price }}">
                                            <button type="submit"
