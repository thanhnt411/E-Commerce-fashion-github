                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100">
                            <div class="slideshow-character position-absolute bottom-0 pos_right-center">
                                <img loading="lazy" src="{{ asset('storage/' . $slide->image) }}" width="542" height="733"
                                    alt="Woman Fashion 1"
                            ...
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    <img loading="lazy" class="w-100 h-auto mb-3"
                                        src="{{ asset('storage/' . $category->image) }}" width="124" height="124"
                                        alt="" />
                                    <div class="text-center">
                                        <a href="#"
                                            class="menu-link fw-medium">{{ $category->name }}<br />{{ $category->slug }}</a>
                                    </div>
                                </div>
                            @endforeach
                                        ...
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    ...
                                                    <img loading="lazy" src="{{ asset('storage/' . $sproduct->image) }}"
                                                        width="258" height="313" alt="{{ $sproduct->name }}"
                                                        class="pc__img">
                                                    <img loading="lazy" src="{{ asset('storage/' . $sproduct->images) }}"
                                                        width="258" height="313" alt="{{ $sproduct->name }}"
                                            ...
                                            <div class="pc__info position-relative">
                                                ...
                                                <div class="product-card__price d-flex">
                                                    <span class="money price-old">{{ $sproduct->regular_price }}</span>
                                                    <span
                                                        class="money price text-secondary">${{ $sproduct->sale_price }}</span>
                                                </div>
                                                ...
                                                <div
                                                    ...
                                                    @if (Cart::instance('cart')->content()->where('id', $sproduct->id)->count() > 0)
                                                        <a href="{{ route('cart.index') }}"
                                                            class="btn-link btn-link_lg me-4 text-uppercase fw-medium js-add-cart  btn-warning ">Go
                                                            to Cart</a>
                                                    @else
